...
function registerRoutes(app, { authService, trustedNetwork, relayTransport, enrollmentWindow, refreshProjectCache, removeFromProjectCache, resolveProject, fileService, fileServiceFor, refreshHostCache, removeFromHostCache, hostPool, ttsService, sttService, moduleService, log: parentLog }) {
  ...
  app.use('/api', createAuthRoutes(authService, trustedNetwork, routeLog.child('Auth'), { enrollmentWindow }));
